...
export const experienceData = [
  createExperience({
    ...
    end_month: month[5],
    end_year: 2023,
    description: ["Backend API and Microservices development", "CI/CD with Docker, kubernetes, and helm on Gitlab and Azure DevOps", "Cloud infrastructure management"],
    skills: [
      "k8s",
      "Docker",
      "Linux",
