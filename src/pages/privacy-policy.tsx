    ...
    <ServiceLayout>
      <div className="flex justify-center">
        <section className="prose prose-lg dark:prose-invert">
          ...
          <p>
            We do not store your personal data on our application. Upon logging
            out, your data is subsequently wiped from our database.
          </p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to AAANH Homepage.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to AAANH Homepage, accessible
                from{" "}
                <a
                  href="https://ms.aaanh.com"
          ...
          <ul>
            <li>
              By email: <a href="mailto:support@aaanh.com">support@aaanh.com</a>
            </li>
          </ul>
        </section>
      </div>
