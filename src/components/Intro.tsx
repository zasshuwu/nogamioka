...
const Intro = () => {
  ...
  return (
    <div className="prose prose-lg dark:prose-invert mx-auto my-4 h-full">
      ...
      <div className="flex items-center justify-center">
        <div className="relative h-32 w-32 rounded-full border">
          <Image
            className="rounded-full m-0 p-1"
        ...
        <ul className="list-none flex sm:space-x-2 space-x-0 flex-wrap">
          <li>
            <a
              className="hover:text-sky-500 transition-all ease-in-out duration-300"
          ...
          <li>
            <a
              className="hover:text-sky-500 transition-all ease-in-out duration-300"
              href="mailto:anhnguyen@aaanh.com"
            >
              <FaMailBulk size={32}></FaMailBulk>
            </a>
          </li>
          <li>
            <a
              className="hover:text-sky-500 transition-all ease-in-out duration-300"
              href="https://photos.aaanh.com"
            >
              <FaCamera size={32}></FaCamera>
            </a>
          </li>
        </ul>
      </div>
