...
const About = () => (
	<Container className="alma-mater card">
		...
		<div>
			<Row className="quickies">
				<Col>
					...
					<h4 class="material-icons">work</h4>
				</Col>
				<Col>
					<h4>Passionate.</h4>
					<h4 class="material-icons">favorite</h4>
				</Col>
				<Col>
					<h4>Driven to learn.</h4>
					<h4 class="material-icons">school</h4>
				</Col>
			</Row>
		</div>
		<br />
		...
		<ul>
			...
			<li>(2014 - 2017) Phổ thông Năng khiếu (High School for the Gifted) - VNU.HCM. Vietnam</li>
		</ul>
		<br />
		<h3>Tech stacks</h3>
		<ul>
		...
		<br />
		<h3>Hobbies</h3>
		<p>Photography, J-Pop, PC master race, gaming with friends, singing/playing guitar, digital arts, writing.</p>
	</Container>
);
