      ...
      <div className=" w-screen sm:w-[60vw] shadow-lg my-12 p-6">
        ...
        <div>
          ...
          <div>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    Ryzen 9 3900X, GTX 1080 8GB, 24GB DDR4 @ 3000 MT/s
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Wireless: Logitech MX Keys &mdash; I mostly enjoy
                    the silent typing and fast device switching.
                  </li>
                  <li>
                    Mechanical: Drop CTRL, Space Grey, Halo Clear
                    &mdash; aesthetic, ergonomic, and try-hard.
                  </li>
                  <li>
                    XY-pointing HID: Logitech G305, White &mdash; best
                    mouse ever, I have 3 more for backups.
                  </li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    <i>
                      Specs: M1 Pro (10 CPU, 16 GPU), 16GB memory,
                      512GB SSD
                    </i>
                  </li>
          ...
          <div>
            ...
            <ul>
              ...
              <li>Sony RX100 II</li>
              <li>
                Lenses: 50mm f/1.8, 70-200mm f/4, aaaand etc. that I
                forgot
              </li>
            </ul>
          </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              Terminal: iTerm2 (Mac), Alacritty (Linux), Windows
              Terminal (duh)
            </li>
            <li>
              Shell: zsh with oh-my-zsh (jonathan theme), bash, csh,
              sh, ps
            </li>
          ...
          <ul>
            <li>
              Font (mono): Fira Code &mdash; I slather this beautiful
              typeface everywhere.
            </li>
            <li>
              Font (sans): Be Vietnam Pro &mdash; free, patriotic{" "}
              {"¯\\_(ツ)_/¯"}, and gorgeous.
            </li>
            <li>Graphics: Photoshop, Lightroom, Affinity Design </li>
            <li>
              Note-taking: GoodNotes (iPadOS), OneNote (Desktop),
              Markdown (universal)
            </li>
        ...
        <div style={{ marginBottom: "2rem" }}>
          <h2 className="text-4xl my-4">
            Photos of my Desk Setup throughout the Time
          </h2>
          <div style={{ display: "flex", flexDirection: "column" }}>
            <h3 className="text-2xl">January, 2022</h3>
            <img
              style={{ width: "50%" }}
              src="/setup/desk_2022.jpeg"
            ></img>
            <h3 className="text-2xl">2021</h3>
            <img
              style={{ width: "50%" }}
              src="/setup/desk_2021.jpeg"
            ></img>
            <h3 className="text-2xl">Work office, 2021</h3>
            <img
              style={{ width: "50%" }}
              src="/setup/desk_work_2021.jpeg"
            ></img>
            <h3 className="text-2xl">2020</h3>
            <img
              style={{ width: "50%" }}
              src="/setup/desk_2020.jpeg"
            ></img>
          </div>
        </div>
        <div>
