      ...
      <HomeLayout currentView="Uses">
        <div className="flex justify-center my-8">
          <div className="prose bg-white dark:bg-neutral-900 z-10 p-4 dark:prose-invert rounded-lg">
            ...
            <h3>
              Strike Group, Amphibious Assault, and Unconventional Warfare
            </h3>
            <ul>
              <li>
                MacBook Pro 16 in., 10-Core Apple M1 Pro, 16-Core GPU, 16GB
                LPDDR5 RAM, 512GB SSD.
              </li>
              <li>
                Framework Laptop 13 in., 8-Core Intel i7-1165G7, Iris Xe iGPU,
                48GB @ 3200MHz RAM, 1TB NVME SSD.
              </li>
              <li>
                Dell Precision 5530, Intel i7-8850H, nVidia Quadro M2000M, 32GB
                RAM, 1TB NVME SSD
              </li>
              <li>MacBook Air 13 in., Apple M1, 8GB RAM, 512GB SSD.</li>
              <li>
                Dell 7390 2-in-1 13 in., Intel i7-8650U, 16GB RAM, 256GB NVME
                SSD.
              </li>
            ...
            <ul>
              <li>
                AMD Ryzen 9 3900X, nVidia RTX 3070 Ti 8GB, 32GB @ 3200MHz RAM.
              </li>
              <li>
                AMD Ryzen 5 3600, nVidia GTX 1080 8GB + nVidia Tesla 24GB, 16GB
                @ 3200MHz RAM
              </li>
            </ul>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    Theme:{' '}
                    <a href="https://marketplace.visualstudio.com/items?itemName=aaanh.artoria-theme">
                      Artoria Themes
                    </a>
                  </li>
              ...
              <li>
                <s>Postman</s> <s>Insomnia</s>{' '}
                <a href="https://usebruno.com">Bruno</a>
              </li>
